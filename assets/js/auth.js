...
// Wrapped in a block scope to prevent global namespace collision of 'const API'
{
  ...
  // ── GLOBAL EXPOSURES ──────────────────────────────────────
  // We explicitly bind entry points to the global window object 
  // so HTML templates can locate them from outside this block scope.
